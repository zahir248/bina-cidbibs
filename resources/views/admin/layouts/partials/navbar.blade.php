...
<nav class="navbar navbar-expand-lg navbar-custom fixed-top">
    <div class="container-fluid">
        <button class="btn d-lg-none mobile-toggle me-3" id="sidebarToggle" style="display: none;">
        ...
        <div class="ms-auto d-flex align-items-center">
            ...
            <!-- Profile Dropdown -->
            <div class="dropdown">
                <button class="btn profile-dropdown dropdown-toggle" type="button" data-bs-toggle="dropdown">
